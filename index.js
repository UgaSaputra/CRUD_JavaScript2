...
function selectData() {
  ...
  //   dataFilter = data;
  // } else {
  //   dataFilter = data.filter((item) => item.jurusan === jurusanDipilih);
  // }

  const dataFilter = jurusanDipilih === '' ? data : data.filter(data => data.jurusan === jurusanDipilih);

  // const umur = '18';
  // (18  === '18') ? console.log("sudah 18 tahun") : console.log("bukan 18 tahun");

  // if(umur > 5 && umur < 50) {
  //   console.log("Sudah bukan balita")
  // } else if(umur > 50) {
  //   console.log("Sudah Lansia")
  // } else {
  //   console.log('Masih Balita')
  // }
